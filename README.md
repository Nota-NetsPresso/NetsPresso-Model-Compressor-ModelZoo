# Model Zoo for the NetsPresso Compressor
...
* Providing the model zoo to help the beginner to try the [NetsPresso Compression Compressor](https://compression.netspresso.ai/).
* Verifying the NetsPresso Compression Compressor.
